...
<body>
	...
	<section>
		...
		<table id="s_table">
			...
			try{
				String sql = "select to_char(a.orderDate,'yyyy-mm-dd'),a.ProductId,b.name,sum(a.orderQty),sum(a.unitprice*a.orderQty) from order0203 a,product0203 b where a.ProductId=b.ProductId group by a.orderDate,a.ProductId,b.name order by a.orderDate asc,a.productId asc,b.name asc";
